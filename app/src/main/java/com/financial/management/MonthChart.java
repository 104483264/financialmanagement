...
import com.financial.management.adapter.ChartVPAdapter;
import com.financial.management.db.DBManager;
import com.financial.management.frag_chart.IncomChartFragment;
import com.financial.management.frag_chart.OutcomChartFragment;
import com.financial.management.utils.CalendarDialog;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.List;
public class MonthChart extends AppCompatActivity {
    Button inBtn,outBtn;
    ...
    private void showCalendarDialog() {
        ...
        dialog.setOnRefreshListener(new CalendarDialog.OnRefreshListener() {
            ...
            public void onRefresh(int selPos, int year, int month) {
                MonthChart.this.selectPos = selPos;
                MonthChart.this.selectMonth = month;
                initStatistics(year,month);
